...
import com.hompan.tueparking.parkingspace.entity.Record;

@Mapper
public interface RecordMapper {
	// 生成新的停车记录
	@Insert("insert into record(seatid,createtime,userid,endtime) values(#{seatid},#{createtime},#{userid},#{endtime})")
	public boolean createRecord(@Param("seatid") int seatid, @Param("createtime") long createtime,
			@Param("userid") int userid, @Param("endtime") long endtime);
